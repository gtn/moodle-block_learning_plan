 ...
 */
$string['pluginname'] = 'Projektplan';
$string['learning_plan'] = 'Projektplan';
$string['learning_plan_name'] = 'Name';
$string['learningpath'] = 'Add Projektplan';
...
$string['assign_training_learningplan'] = 'zuordnen der Aufgaben zum Projektplan';
$string['training_name'] = 'Name der Aufgabe im Projekt';
$string['learningplan'] = 'Projektplan';
$string['training'] = 'Course name';
$string['add_learningplan'] = 'Add Projektplan';
$string['trainingstatus'] = 'Set training status';
$string['remarks'] = 'Remarks';
$string['status'] = 'Status';
$string['assign_learningplan_user'] = 'Assign Projektplan to users';
$string['addusers'] = 'Add users';
$string['searchusers'] = 'Search users';
$string['showuser'] = 'Show users';
$string['block/learning_plan:viewpages'] = 'Projektplan view pages';
$string['block/learning_plan:managepages'] = 'Projektplan manage pages';
$string['myview'] = 'My Projektplan';
$string['search'] = 'Search';
$string['status_report'] = 'Status report';
$string['report_at'] = 'Report as at';
$string['plan_format'] = 'Please add Projektplan in correct format.';
$string['plan_exist'] = 'Projektplan already exist';
...
$string['plan_delete'] = 'Do you want to delete Projektplan?';
...
$string['select_learningplan'] = 'Please select Projektplan';